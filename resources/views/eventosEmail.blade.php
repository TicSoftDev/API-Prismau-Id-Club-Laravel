                ...
                <table width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p>Nos complace invitarle a participar en el siguiente evento organizado por el Club
                                Sincelejo. A continuación, encontrará los detalles:</p>
                            ...
                            <table width="100%"
                                ...
                                <tr>
                                    <td
                                        ...
                                        Título del Evento:</td>
                                    <td
                                        style="background-color: #fff; border: 1px solid #ddd; padding: 15px; font-weight: bold;">
                                        {{ $titulo }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                @if (isset($fechaEvento) && isset($horaEvento))
                                    <tr>
                                        <td
                                            style="background-color: #f8f8f8; border-bottom: 1px solid #ddd; padding: 15px; font-weight: bold; color: #015712;">
                                            Fecha y Hora:</td>
                                        <td style="border: 1px solid #ddd; padding: 15px;">
                                            {{ $fechaEvento }} a las {{ $horaEvento }}
                                        </td>
                                    </tr>
                                @endif
                            </table>

                            <p>Esperamos contar con su valiosa presencia. Para más información, no dude en comunicarse
                                con la gerencia del club.</p>
